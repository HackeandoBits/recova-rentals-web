...
<div
    class="@if ($style === 'card') bg-[hsl(298,42%,15%)] text-white rounded-lg shadow-lg p-6 w-full h-full flex flex-col justify-start items-start @else space-y-6 @endif">
    ...
    <p class="ml-auto text-center text-sm text-muted-foreground">Contamos con un equipo de profesionales apasionados por
        la tecnología audiovisual, con años de experiencia en la industria del entretenimiento y eventos corporativos.
        Cada miembro de nuestro equipo está certificado y en constante capacitación para ofrecer el mejor servicio.</p>

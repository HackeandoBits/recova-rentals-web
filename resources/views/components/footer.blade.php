<footer class="bg-gray-900 border-t border-purple-500/30 relative overflow-hidden">
    ...
    <div
        class="absolute top-0 left-1/2 -translate-x-1/2 w-full h-1 bg-gradient-to-r from-transparent via-purple-500 to-transparent opacity-50">
    </div>
    ...
    <div class="container mx-auto px-4 py-16 relative z-10">
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
            ...
            <div class="space-y-6">
                <div>
                    <h3
                        class="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-pink-600 mb-4 inline-block">
                        RECOVA RENTALS
                    </h3>
                ...
                <div class="flex space-x-4">
                    <a href="https://www.instagram.com/recovarentals/" target="_blank"
                        class="w-10 h-10 rounded-full bg-gray-800 border border-gray-700 flex items-center justify-center text-gray-400 hover:text-white hover:border-purple-500 hover:bg-purple-500/10 transition-all duration-300 group">
                        <i class="fab fa-instagram text-lg group-hover:scale-110 transition-transform"></i>
                    </a>
                    <a href="https://www.facebook.com/lanuevarecova.restaurante" target="_blank"
                        class="w-10 h-10 rounded-full bg-gray-800 border border-gray-700 flex items-center justify-center text-gray-400 hover:text-white hover:border-blue-500 hover:bg-blue-500/10 transition-all duration-300 group">
            ...
            <div class="space-y-6">
                ...
                <ul class="space-y-3">
                    <li>
                        <a href="{{ route('home') }}"
                            class="group flex items-center text-gray-400 hover:text-purple-400 transition-colors text-sm">
                            <span
                                class="w-1.5 h-1.5 rounded-full bg-purple-600 mr-2 opacity-0 group-hover:opacity-100 transition-opacity"></span>
                            Inicio
                        </a>
                    </li>
                    <li>
